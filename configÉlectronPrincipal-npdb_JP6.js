import{w as F}from"./index-xMlaZgtg.js";import{w as H,A as z}from"./const-UkZJj0SE.js";import{w as V}from"./index-pLHssmkz.js";import{w as X}from"./index-kjy263JT.js";import{a as Y,e as C,Q as _,a1 as T,r as K,g as Z}from"./index-wr59-EDT.js";import{r as ee}from"./path-TnDa5oq_.js";import{b as S}from"./browser-PGHVSA1T.js";var I={exports:{}},W={exports:{}},x={};const J="/home/runner/work/iug/iug/node_modules/electron";var E={};const k=Y,$=ee,L=$.join(J,"path.txt");function te(){let l;if(k.existsSync(L)&&(l=k.readFileSync(L,"utf-8")),E.ELECTRON_OVERRIDE_DIST_PATH)return $.join(E.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(J,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var j=te(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ne=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
...
//# sourceMappingURL=configÉlectronPrincipal-npdb_JP6.js.map
