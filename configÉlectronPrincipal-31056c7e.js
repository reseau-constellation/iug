import{x as U,y as F,z,B as _,D as C,E as S,F as T,G as H,k as V,w as X}from"./index-db0b30c7.js";import{w as Y,A as K}from"./const-c8799a99.js";import{w as Z}from"./index-944d45f5.js";import{w as ee}from"./index-6e5ef070.js";const te=U(F);var I={exports:{}},x={exports:{}},W={};const B="/home/runner/work/iug/iug/node_modules/electron",E=z,$=te,k=$.join(B,"path.txt");function ne(){let l;if(E.existsSync(k)&&(l=E.readFileSync(k,"utf-8")),{}.ELECTRON_OVERRIDE_DIST_PATH)return $.join({}.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(B,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var J=ne(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ie=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
...
//# sourceMappingURL=configÉlectronPrincipal-31056c7e.js.map
