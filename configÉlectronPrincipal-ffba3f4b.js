import{w as U}from"./index-547527d3.js";import{w as F,A as H}from"./const-83288eea.js";import{w as V}from"./index-73ac1dca.js";import{w as X}from"./index-cae169d2.js";import{v as z,V as Y,a as K,W as _,m as C,J as S,X as T,r as Z,i as ee}from"./index-e36dafd7.js";var I={exports:{}},W={exports:{}},x={};const B="/home/runner/work/iug/iug/node_modules/electron",te=z(Y),E=K,$=te,k=$.join(B,"path.txt");function ne(){let l;if(E.existsSync(k)&&(l=E.readFileSync(k,"utf-8")),{}.ELECTRON_OVERRIDE_DIST_PATH)return $.join({}.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(B,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var J=ne(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ie=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
