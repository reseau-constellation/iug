import{w as F}from"./index-7a76Zttc.js";import{w as H,A as z}from"./const-1us33FlA.js";import{w as V}from"./index-tOFDRnSP.js";import{w as X}from"./index-XLExmkwY.js";import{a as Y,e as C,Q as _,a1 as T,r as K,g as Z}from"./index-k6Ok1D-T.js";import{r as ee}from"./path-6GGKABeP.js";import{b as S}from"./browser-0TyTtunY.js";var I={exports:{}},W={exports:{}},x={};const J="/home/runner/work/iug/iug/node_modules/electron";var E={};const k=Y,$=ee,L=$.join(J,"path.txt");function te(){let l;if(k.existsSync(L)&&(l=k.readFileSync(L,"utf-8")),E.ELECTRON_OVERRIDE_DIST_PATH)return $.join(E.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(J,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var j=te(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ne=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
...
//# sourceMappingURL=configÉlectronPrincipal--aaFiUME.js.map
