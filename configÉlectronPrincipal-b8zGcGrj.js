import{w as F}from"./index-eh2gUWN-.js";import{w as H,A as z}from"./const-kdy8NzJU.js";import{w as V}from"./index-6ap-057s.js";import{w as X}from"./index-B4coiuOr.js";import{a as Y,e as C,Q as _,a1 as T,r as K,g as Z}from"./index-kTI-uCTQ.js";import{r as ee}from"./path-50HWAKbj.js";import{b as S}from"./browser-7AA1OqYT.js";var I={exports:{}},W={exports:{}},x={};const J="/home/runner/work/iug/iug/node_modules/electron";var E={};const k=Y,$=ee,L=$.join(J,"path.txt");function te(){let l;if(k.existsSync(L)&&(l=k.readFileSync(L,"utf-8")),E.ELECTRON_OVERRIDE_DIST_PATH)return $.join(E.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(J,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var j=te(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ne=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
...
//# sourceMappingURL=configÉlectronPrincipal-b8zGcGrj.js.map
