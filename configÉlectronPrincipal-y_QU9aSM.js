import{w as pe,__tla as ge}from"./index-uM_bU_dM.js";import{w as ye,A as we,__tla as me}from"./const-5mbIvjE4.js";import{w as be,__tla as _e}from"./index-vR7eZSh1.js";import{w as ve,__tla as Se}from"./index-pwqtNmIE.js";import{a as Ce,e as v,Q as S,a2 as $,r as Re,g as Te,__tla as Me}from"./index-aicZefrG.js";import{r as Oe,__tla as Ie}from"./path-wXZ93Fmk.js";import{b as C,__tla as De}from"./browser-ntcpwhPk.js";let G,$e=Promise.all([(()=>{try{return ge}catch{}})(),(()=>{try{return me}catch{}})(),(()=>{try{return _e}catch{}})(),(()=>{try{return Se}catch{}})(),(()=>{try{return Me}catch{}})(),(()=>{try{return Ie}catch{}})(),(()=>{try{return De}catch{}})()]).then(async()=>{var R={exports:{}},T={exports:{}},M={};const W="/home/runner/work/iug/iug/node_modules/electron";var x={};const L=Ce,O=Oe,k=O.join(W,"path.txt");function U(){let s;if(L.existsSync(k)&&(s=L.readFileSync(k,"utf-8")),x.ELECTRON_OVERRIDE_DIST_PATH)return O.join(x.ELECTRON_OVERRIDE_DIST_PATH,s||"electron");if(s)return O.join(W,"dist",s);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var A=U(),w={};Object.defineProperty(w,"__esModule",{value:!0}),w.getRelayWindow=void 0;const F=(s,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
