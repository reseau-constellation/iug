import{w as G}from"./index-2679e334.js";import{w as F,A as H}from"./const-4e8870f0.js";import{w as z}from"./index-2104e4a1.js";import{w as V}from"./index-a9c6b2a0.js";import{D as X,a3 as Y,a as K,a4 as _,m as C,U as S,a5 as T,r as Z,i as ee}from"./index-f968cfc1.js";var I={exports:{}},W={exports:{}},x={};const B="/home/runner/work/iug/iug/node_modules/electron",te=X(Y),E=K,$=te,k=$.join(B,"path.txt");function ne(){let l;if(E.existsSync(k)&&(l=E.readFileSync(k,"utf-8")),{}.ELECTRON_OVERRIDE_DIST_PATH)return $.join({}.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(B,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var J=ne(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ie=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
...
//# sourceMappingURL=configÉlectronPrincipal-03b294aa.js.map
