import{w as F}from"./index-EAZKt8eL.js";import{w as H,A as V}from"./const-z5RTqz1I.js";import{w as z}from"./index-iVC62TgL.js";import{w as X}from"./index-yJZ90h1_.js";import{a as Y,i as C,V as _,a6 as T,r as K,g as Z}from"./index-1FgDP14y.js";import{r as ee}from"./path-7aPEHEp_.js";import{b as S}from"./browser-MjyPfT7D.js";var I={exports:{}},W={exports:{}},x={};const J="/home/runner/work/iug/iug/node_modules/electron";var E={};const k=Y,$=ee,L=$.join(J,"path.txt");function te(){let l;if(k.existsSync(L)&&(l=k.readFileSync(L,"utf-8")),E.ELECTRON_OVERRIDE_DIST_PATH)return $.join(E.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(J,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var j=te(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ne=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
...
//# sourceMappingURL=configÉlectronPrincipal-VoV_yyed.js.map
