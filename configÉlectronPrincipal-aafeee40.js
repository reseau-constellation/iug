import{Z as R,$ as m,a0 as T,a1 as D,a2 as J,a3 as Q,a4 as j,K as G,a5 as U}from"./index-e711499b.js";import{w as F,A as z}from"./const-28f4fd92.js";import{w as H}from"./index-ba135526.js";import{e as P}from"./index-6ba6b4c0.js";var _={},X={get exports(){return _},set exports(l){_=l}},S={},K={get exports(){return S},set exports(l){S=l}},I={},M={};Object.defineProperty(M,"__esModule",{value:!0});M.getRelayWindow=void 0;const Y=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
  ...
  `;M.getRelayWindow=Y;Object.defineProperty(I,"__esModule",{value:!0});const O=P,Z=M,V=R,f=V("electron-webrtc-relay:ResourceManager");class ee{constructor(n,r){this.maxWindows=1,this.windowIDtoStatsMap=new Map,this.referenceToWindowMap=new Map,this.rollingCounter={i:0,length:0},this.internalWindowCounter=0,this.internalWindowQueueBuffer=0,this.opts=n,typeof this.opts.maxWindows>"u"&&(this.opts.maxWindows=1),this.maxWindows=this.opts.maxWindows,this.opts.debug&&(f.enabled=!0),this.registerListener(),this.openWindow(r)}openWindow(n){if(f("trying to create window"),this.internalWindowQueueBuffer+=15,this.internalWindowCounter>=this.maxWindows)return!1;const r=this.internalWindowCounter.toString();this.internalWindowCounter++,f(`creating window: ${r}`);const a=new O.BrowserWindow({title:"WRTC Relay",width:this.opts.debug?900:0,height:this.opts.debug?750:0,transparent:!this.opts.debug,frame:this.opts.debug,alwaysOnTop:!1,skipTaskbar:!0,center:!0,show:!0,webPreferences:{nodeIntegration:typeof this.opts.preload!="string",contextIsolation:typeof this.opts.preload=="string",webSecurity:!0,preload:typeof this.opts.preload=="string"?this.opts.preload:"",devTools:!!this.opts.debug}});this.opts.debug&&a.webContents.openDevTools(),a.webContents.setWebRTCIPHandlingPolicy(typeof this.opts.webrtcPolicy=="string"?this.opts.webrtcPolicy:"default");const c="data:text/html;charset=UTF-8,"+encodeURIComponent((0,Z.getRelayWindow)(typeof this.opts.preload=="string",typeof this.opts.debug<"u"&&this.opts.debug));return a.loadURL(c),a.on("ready-to-show",()=>{a.webContents.send("WRTCRelayData",{id:"relayInit",code:`window.windowID = ${r}
      ...
      `,i=>{for(let o of i){let u=o.stats;delete o.stats,o.names=()=>Object.keys(u),o.stat=g=>u[g]}e({result:()=>i})})}_eval(e,i,o){let u,g;const y=new Promise((p,B)=>{u=p,g=B}),w=r.default.randomBytes(16).toString("hex");return c.once(w,p=>{p.err?(o&&o(p.err),g(p.err)):(i&&i(p.res),u(p.res))}),c.eval(JSON.stringify(this._id),`
        (function () {
      ...
      `,p=>{p&&h.emit("error",p,this)}),y}_callRemote(e,i,o,u){return this._eval(`pc.${e}(${i||""})`,o,u)}}},b}var W,L;function ce(){return L||(L=1,W=class{constructor(n){this.type=n.type,this.sdp=n.sdp}toJSON(){return this}}),W}var $,E;function le(){return E||(E=1,$=class{constructor(n){this.candidate=n.candidate,this.sdpMid=n.sdpMid,this.sdpMLineIndex=n.sdpMLineIndex}}),$}Object.defineProperty(_,"__esModule",{value:!0});const ue=T,he=S;X.exports=function(l){const n=new he(l),r=new ue.EventEmitter;return Object.assign(r,{close:n.close.bind(n),electronDaemon:n,init:n.init.bind(n),RTCPeerConnection:de()(n,r),RTCSessionDescription:ce(),RTCIceCandidate:le(),RTCDataChannel:N()(n,r)})};const fe=Q(_),q=fe();q.init();const A=j({wrtc:q}),Se={libp2p:{transports:[H(),G(),A.transport,F()],peerDiscovery:[A.discovery],dht:U(),addresses:{listen:z}}};export{Se as default};
//# sourceMappingURL=configÉlectronPrincipal-aafeee40.js.map
