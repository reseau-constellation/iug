import{aG as R,aH as m,aI as T,aJ as D,aK as B,aL as Q,aM as j,at as G,aN as U}from"./index-f71c8db3.js";import{w as F,A as H}from"./const-b5afb733.js";import{w as z}from"./index-bd5e11cd.js";import{e as P}from"./index-a273f134.js";var _={},X={get exports(){return _},set exports(l){_=l}},S={},K={get exports(){return S},set exports(l){S=l}},$={},M={};Object.defineProperty(M,"__esModule",{value:!0});M.getRelayWindow=void 0;const Y=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
  ...
  `;M.getRelayWindow=Y;Object.defineProperty($,"__esModule",{value:!0});const O=P,V=M,Z=R,f=Z("electron-webrtc-relay:ResourceManager");class ee{constructor(n,r){this.maxWindows=1,this.windowIDtoStatsMap=new Map,this.referenceToWindowMap=new Map,this.rollingCounter={i:0,length:0},this.internalWindowCounter=0,this.internalWindowQueueBuffer=0,this.opts=n,typeof this.opts.maxWindows>"u"&&(this.opts.maxWindows=1),this.maxWindows=this.opts.maxWindows,this.opts.debug&&(f.enabled=!0),this.registerListener(),this.openWindow(r)}openWindow(n){if(f("trying to create window"),this.internalWindowQueueBuffer+=15,this.internalWindowCounter>=this.maxWindows)return!1;const r=this.internalWindowCounter.toString();this.internalWindowCounter++,f(`creating window: ${r}`);const a=new O.BrowserWindow({title:"WRTC Relay",width:this.opts.debug?900:0,height:this.opts.debug?750:0,transparent:!this.opts.debug,frame:this.opts.debug,alwaysOnTop:!1,skipTaskbar:!0,center:!0,show:!0,webPreferences:{nodeIntegration:typeof this.opts.preload!="string",contextIsolation:typeof this.opts.preload=="string",webSecurity:!0,preload:typeof this.opts.preload=="string"?this.opts.preload:"",devTools:!!this.opts.debug}});this.opts.debug&&a.webContents.openDevTools(),a.webContents.setWebRTCIPHandlingPolicy(typeof this.opts.webrtcPolicy=="string"?this.opts.webrtcPolicy:"default");const c="data:text/html;charset=UTF-8,"+encodeURIComponent((0,V.getRelayWindow)(typeof this.opts.preload=="string",typeof this.opts.debug<"u"&&this.opts.debug));return a.loadURL(c),a.on("ready-to-show",()=>{a.webContents.send("WRTCRelayData",{id:"relayInit",code:`window.windowID = ${r}
                       window.conns = {}`}),this.windowIDtoStatsMap.set(r,{handler:0,window:a}),this.rollingCounter.length++,this.internalWindowQueueBuffer-=15,typeof n=="function"&&n()}),!0}registerListener(){O.ipcMain.on("WRTCRelayStats",(n,r)=>{try{if(!this.windowIDtoStatsMap.has(r.id.toString())){f(`Resource Manager can not find stats of window: ${r.id}`);return}const a=this.windowIDtoStatsMap.get(r.id.toString());if(typeof a>"u")return;a.handler=r.handler,f(`webrtc window: ${r.id} has ${r.handler} open handler`)}catch(a){f(a)}}),O.ipcMain.on("WRTCRelayClose",(n,r)=>{try{this.referenceToWindowMap.delete(r.id.toString())}catch(a){f(a)}})}getStringID(){return this.rollingCounter.i.toString()}eval(n,r,a){var c,h,t,s,d;if(this.referenceToWindowMap.has(n)&&this.windowIDtoStatsMap.has(this.referenceToWindowMap.get(n))){f(`window with id: ${this.referenceToWindowMap.get(n)} handling reference: ${n}`),(c=this.windowIDtoStatsMap.get(this.referenceToWindowMap.get(n)))===null||c===void 0||c.window.webContents.send("WRTCRelayData",{id:r,code:a});return}if(this.rollingCounter.i++,this.rollingCounter.i>=this.rollingCounter.length&&(this.rollingCounter.i=0),!this.windowIDtoStatsMap.has(this.getStringID())){f(`window with id: ${this.rollingCounter.i} does not exist`);return}if(((t=(h=this===null||this===void 0?void 0:this.windowIDtoStatsMap)===null||h===void 0?void 0:h.get(this.getStringID()))===null||t===void 0?void 0:t.handler)<300+this.internalWindowQueueBuffer){f(`window with id: ${this.getStringID()} handling new reference: ${n}`),(d=(s=this===null||this===void 0?void 0:this.windowIDtoStatsMap)===null||s===void 0?void 0:s.get(this.getStringID()))===null||d===void 0||d.window.webContents.send("WRTCRelayData",{id:r,code:a}),this.referenceToWindowMap.set(n,this.getStringID());return}let e;if(this.windowIDtoStatsMap.forEach((i,o)=>{(typeof e>"u"||i.handler<e.handler)&&(e={handler:i.handler,window:i.window,id:o})}),typeof e>"u"){f("failed to find lowestQueue");return}e.handler>250+this.internalWindowQueueBuffer&&this.openWindow(),e.window.webContents.send("WRTCRelayData",{id:r,code:a}),this.referenceToWindowMap.set(n,e.id),f(`window with id, selected by enumeration: ${e.id} handling new reference: ${n}`)}}$.default=ee;var te=m&&m.__importDefault||function(l){return l&&l.__esModule?l:{default:l}};Object.defineProperty(S,"__esModule",{value:!0});const ne=te($),{ipcMain:ie}=P,re=R,se=T,C=re("electron-webrtc-relay:Bridge");K.exports=class extends se{constructor(n){super(),this.i=0,this.queue=[],this.ready=!1,this.closing=!1,this.opts={debug:!1},this.resourceManager=void 0,typeof n>"u"&&(n={debug:!1}),this.opts=n,n.debug&&(C.enabled=!0)}_debug(n){this.opts.debug&&C(n)}init(){this._debug(`Initializing Relay: ${JSON.stringify(this.opts)}`),this.resourceManager=new ne.default(this.opts,()=>{C("Bridge ready"),this.ready=!0,this._queue()}),ie.on("WRTCRelayData",(n,r)=>{typeof r=="object"&&(C(`Received: ${JSON.stringify(r)}`),this.emit(r[0],r[1]))})}_queue(){this.queue.forEach(n=>{this.resourceManager&&this.resourceManager.eval(n.reference,n.id,n.code)}),this.queue=[]}eval(n,r,a={},c){const h=!this.ready;typeof a=="function"&&(c=a,a={}),this._debug(`opts: ${JSON.stringify(a)} eval: ${JSON.stringify(r)}, BrowserWindow active: ${!h}`);const t=(this.i++).toString(36);if(this.once(t,s=>{let d=null;if(s.err&&(d=new Error(`Error evaluating "${r}" ${s.err}`),d.original=s.err),c)return d?c(d):c(null,s.res);d&&console.error(d)}),h){this.queue.push({id:t,code:r,reference:n});return}this.resourceManager&&this.resourceManager.eval(n,t,r)}close(){}};var b={},oe={get exports(){return b},set exports(l){b=l}},v={},ae={get exports(){return v},set exports(l){v=l}},x;function N(){if(x)return v;x=1,Object.defineProperty(v,"__esModule",{value:!0});const l=T,n=R("RTCDC");ae.exports=function(a,c){return class extends l.EventEmitter{constructor(t,s,d){super(),this.protocol="",this.addEventListener=this.addListener,typeof t=="object"?this._wrap(t):this._create(t,s,d)}_create(t,s,d){d=d||{},this._pcId=t,this.label=s,this.ordered=null,this.protocol="",this.id=this.stream=null,this.readyState="connecting",this.bufferedAmount=0,this._bufferedAmountLowThreshold=0,this._binaryType="blob",this.maxPacketLifeType=null,this.maxRetransmits=null,this.negotiated=!1,this.reliable=typeof d.reliable=="boolean"?d.reliable:!0,this.on("error",e=>c.emit("error",e,this)),a.eval(JSON.stringify(t),`
      ...
      `,(e,i)=>{if(e)return console.error(e);this.id=this.stream=i,this._registerListeners(),this.emit("init")})}_wrap(t){for(let s in t)this[s]=t[s];this.stream=this.id,this._registerListeners(),this.on("error",s=>c.emit("error",s,this))}_registerListeners(t){a.on(`dc:${this._pcId}:${this.id}`,this.onMessage.bind(this)),this._eval(`
        ...
        dc.msgQueue = null
      `,t||(s=>{s&&console.error(s)}))}onMessage(t){const s=this["on"+t.type],d=t.event||{};switch(n("<<",this.id,t.type,t,!!s),t.type){case"open":this.readyState="open";break;case"message":if(t.dataType==="binary"){const e=new D(d.data,"base64");d.data=e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}break;case"close":this.readyState="closed";break}this.emit(t.type,d),s&&s(d)}close(){this.readyState="closing",this._eval("if (dc) dc.close()",t=>{t&&console.error(t)})}send(t){let s="";(t instanceof ArrayBuffer||t instanceof Uint8Array)&&(t=r(t)),t instanceof D&&(t=t.toString("base64"),s="data = base64ToArrayBuffer(data)"),this._eval(`
      ...
      `+t,s||(d=>{d&&console.error(d)}))}_setProp(t,s){return this.id==null?this.once("init",()=>this._setProp(t,s)):this._eval(`dc["${t}"] = ${JSON.stringify(s)}`)}get bufferedAmountLowThreshold(){return this._bufferedAmountLowThreshold}set bufferedAmountLowThreshold(t){this._bufferedAmountLowThreshold=t,this._setProp("bufferedAmountLowThreshold",t)}get binaryType(){return this._binaryType}set binaryType(t){this._binaryType=t,this._setProp("binaryType",t)}}};function r(a){const c=new D(a.byteLength),h=new Uint8Array(a);for(let t=0;t<c.length;++t)c[t]=h[t];return c}return v}var k;function de(){if(k)return b;k=1;var l=m&&m.__importDefault||function(c){return c&&c.__esModule?c:{default:c}};Object.defineProperty(b,"__esModule",{value:!0});const n=T,r=l(B()),a=R("RTCPC");return oe.exports=function(c,h){const t=N()(c,h);let s=0;return class extends n.EventEmitter{constructor(e){if(super(),this.addEventListener=this.addListener,c.closing)throw new Error("Cannot create RTCPeerConnection, the electron-webrtc daemon has been closed");this._id=(s++).toString(36),this._dataChannels=new Map,this._offer=null,this._answer=null,this.iceConnectionState="new",this.iceGatheringState="new",this.localDescription=null,this.peerIdentity={catch:i=>{console.error(i)}},this.remoteDescription=null,this.signalingState="stable",c.on(`pc:${this._id}`,this.onMessage.bind(this)),c.eval(JSON.stringify(this._id),`
        (function () {
      ...
      `,i=>{for(let o of i){let u=o.stats;delete o.stats,o.names=()=>Object.keys(u),o.stat=g=>u[g]}e({result:()=>i})})}_eval(e,i,o){let u,g;const y=new Promise((p,q)=>{u=p,g=q}),w=r.default.randomBytes(16).toString("hex");return c.once(w,p=>{p.err?(o&&o(p.err),g(p.err)):(i&&i(p.res),u(p.res))}),c.eval(JSON.stringify(this._id),`
        (function () {
      ...
      `,p=>{p&&h.emit("error",p,this)}),y}_callRemote(e,i,o,u){return this._eval(`pc.${e}(${i||""})`,o,u)}}},b}var W,L;function ce(){return L||(L=1,W=class{constructor(n){this.type=n.type,this.sdp=n.sdp}toJSON(){return this}}),W}var I,E;function le(){return E||(E=1,I=class{constructor(n){this.candidate=n.candidate,this.sdpMid=n.sdpMid,this.sdpMLineIndex=n.sdpMLineIndex}}),I}Object.defineProperty(_,"__esModule",{value:!0});const ue=T,he=S;X.exports=function(l){const n=new he(l),r=new ue.EventEmitter;return Object.assign(r,{close:n.close.bind(n),electronDaemon:n,init:n.init.bind(n),RTCPeerConnection:de()(n,r),RTCSessionDescription:ce(),RTCIceCandidate:le(),RTCDataChannel:N()(n,r)})};const fe=Q(_),J=fe();J.init();const A=j({wrtc:J}),Se={libp2p:{transports:[z(),G(),A.transport,F()],peerDiscovery:[A.discovery],dht:U(),addresses:{listen:H}}};export{Se as default};
//# sourceMappingURL=configÉlectronPrincipal-47ad8156.js.map
