...
import {கிளி, பங்கேற்பாளர்_நெடுவரிசை_அடையாளம்} from '@lassi-js/kili';
...
export class கிளிமூக்கு extends கிளி<மொழிபெயர்ப்பு_பரிந்துரை_உறுப்படி_வகை> {
      ...
      செ: async உறுப்படிகள் => {
        const அங்கீகரிக்கப்பட்டவை = மொழிபெயர்ப்புகளை_ஒன்றாக்கு(
          மொழிபெயர்ப்பு_பட்டியலிலிருந்து_அரகாதி(
            உறுப்படிகள்.map(இ => மொழிபெயர்ப்பு_உறுப்படியிலிருந்து_மொழிபெயர்ப்பு_முடிவு(இ)),
          ),
  ...
  async முன்னேற்றத்தை_கேள்ளு({
    ...
    const செ_கடைசி = async () => {
      ...
      if (வகை === 'சாபி') {
        ...
        const அங்கீகரிக்கப்பட்டவை = தகவல்கள்.சாபிகள்.filter(
          சாபி => தகவல்கள்.அங்கீகரிக்கப்பட்டவை?.[சாபி]?.[மொழி],
        );
        ...
        if (!தகவல்கள்.அங்கீகரிக்கப்பட்டவை || !தகவல்கள்.சாபிகள்) return;

        const அளவு = Object.fromEntries(
          தகவல்கள்.சாபிகள்.map(சாபி => [
            சாபி,
            தகவல்கள்.அங்கீகரிக்கப்பட்டவை?.[சாபி]?.[this.மூல்_மொழி].length || 0,
          ]),
        );
        const மொத்தம் = தகவல்கள்.சாபிகள்.map(சாபி => அளவு[சாபி]).reduce((இ, ஈ) => இ + ஈ, 0);
        const அங்கீகரிக்கப்பட்டவை = Object.keys(தகவல்கள்.அங்கீகரிக்கப்பட்டவை)
          .map(சாபி => அளவு[சாபி])
          .reduce((இ, ஈ) => இ + ஈ, 0);
        const பரிந்துரைக்கப்பட்டவை =
    ...
    const சாபிகளை_மறந்துவிடு = await this.சாபிகளை_கேள்ளு({
      செ: async சாபிகள் => {
    ...
    const அங்கீகரிக்கப்பட்டவையை_மறந்துவிடு = await this.அங்கீகரிக்கப்பட்ட_மொழிபெயர்ப்புகளை_கேள்ளு({
    ...
    const பரிந்துரைகளை_மறந்துவிடு = await this.மொழிபெயர்ப்பு_பரிந்துரைகளை_கேள்ளு({
      மொழி,
      செ: async பரிந்துரைகள் => {
    ...
    const மறந்துவிடு = async () => {
      await சாபிகளை_மறந்துவிடு();
      await பரிந்துரைகளை_மறந்துவிடு.fOublier();
      await அங்கீகரிக்கப்பட்டவையை_மறந்துவிடு();
    };
    return மறந்துவிடு;
  }
