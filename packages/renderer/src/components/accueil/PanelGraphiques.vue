...
enregistrerÉcoute(
  constl?.bds.suivreBds({f: x=>bds.value = x}),
);
watchEffect(()=>{
...
enregistrerÉcoute(
  constl?.projets.suivreProjets({f: x=>projets.value = x}),
);
watchEffect(()=>{
...
enregistrerÉcoute(
  constl?.nuées.suivreNuées({f: x=>nuées.value = x}),
);
watchEffect(()=>{
...
enregistrerÉcoute(
  constl?.réseau.suivreFiables({f: x=>membresFiables.value = x}),
);
watchEffect(()=>{
