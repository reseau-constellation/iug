...
const obtenirDernièreVersion = async (): Promise<{versionPlusRécente: string, urlTéléchargement: string} | undefined> => {
    ...
    return (versionPlusRécente && urlTéléchargement) ? {versionPlusRécente, urlTéléchargement} : undefined;
};
