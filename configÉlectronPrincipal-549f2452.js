import{y as _,z as C,B as S,D as T,E as J,k as Q,w as j}from"./index-594d3a3e.js";import{w as G,A as U}from"./const-0ed3a9fc.js";import{w as F}from"./index-08c9afb1.js";import{w as z}from"./index-2b728ac4.js";import{e as P}from"./index-2c05197e.js";var $={exports:{}},W={exports:{}},I={},R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const X=(u,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
      <p>WRTC Relay</p>
        <script>
          ...
          const queue = []
          const ipcRenderer = ${u?"window.ipcRenderer":"require('electron').ipcRenderer"}           
          require = null;
          window.require = null;
          // endregion
  ...
  `;R.getRelayWindow=X;Object.defineProperty(I,"__esModule",{value:!0});const M=P,H=R,Y=_,f=Y("electron-webrtc-relay:ResourceManager");class K{constructor(n,r){this.maxWindows=1,this.windowIDtoStatsMap=new Map,this.referenceToWindowMap=new Map,this.rollingCounter={i:0,length:0},this.internalWindowCounter=0,this.internalWindowQueueBuffer=0,this.opts=n,typeof this.opts.maxWindows>"u"&&(this.opts.maxWindows=1),this.maxWindows=this.opts.maxWindows,this.opts.debug&&(f.enabled=!0),this.registerListener(),this.openWindow(r)}openWindow(n){if(f("trying to create window"),this.internalWindowQueueBuffer+=15,this.internalWindowCounter>=this.maxWindows)return!1;const r=this.internalWindowCounter.toString();this.internalWindowCounter++,f(`creating window: ${r}`);const a=new M.BrowserWindow({title:"WRTC Relay",width:this.opts.debug?900:0,height:this.opts.debug?750:0,transparent:!this.opts.debug,frame:this.opts.debug,alwaysOnTop:!1,skipTaskbar:!0,center:!0,show:!0,webPreferences:{nodeIntegration:typeof this.opts.preload!="string",contextIsolation:typeof this.opts.preload=="string",webSecurity:!0,preload:typeof this.opts.preload=="string"?this.opts.preload:"",devTools:!!this.opts.debug}});this.opts.debug&&a.webContents.openDevTools(),a.webContents.setWebRTCIPHandlingPolicy(typeof this.opts.webrtcPolicy=="string"?this.opts.webrtcPolicy:"default");const c="data:text/html;charset=UTF-8,"+encodeURIComponent((0,H.getRelayWindow)(typeof this.opts.preload=="string",typeof this.opts.debug<"u"&&this.opts.debug));return a.loadURL(c),a.on("ready-to-show",()=>{a.webContents.send("WRTCRelayData",{id:"relayInit",code:`window.windowID = ${r}
      ...
      `,i=>{i&&h.emit("error",i,this)})}onMessage(e){const i=this["on"+e.type],o=e.event||{};switch(a(this._id+"<<",e.type,e,!!i),e.type){case"addstream":break;case"datachannel":e.channel._pcId=this._id,o.channel=new t(e.channel),this._dataChannels.set(o.channel.id,o.channel);break;case"icecandidate":this.iceGatheringState=e.iceGatheringState,e.offer&&(this._offer=Object.assign(this._offer||{},e.offer));break;case"iceconnectionstatechange":this.iceConnectionState=e.iceConnectionState;break;case"removestream":break;case"signalingstatechange":this.signalingState=e.signalingState;break}this.emit(e.type,o),i&&i(o)}createDataChannel(e,i){const o=new t(this._id,e,i);return o.once("init",()=>this._dataChannels.set(o.id,o)),o}_getCreateArgs(e,i,o){return e&&i?{cb:e,errCb:i,options:o}:{options:e}}createOffer(e,i,o){let{cb:l,errCb:g,options:y}=this._getCreateArgs(e,i,o);return this._offer&&(l&&l(this._offer),Promise.resolve(this._offer)),this._callRemote("createOffer",`onSuccess, onFailure, ${JSON.stringify(y)}`,w=>{this._offer=w,l&&l(w)},g)}createAnswer(e,i,o){let{cb:l,errCb:g,options:y}=this._getCreateArgs(e,i,o);return this._answer&&(l&&l(this._answer),Promise.resolve(this._answer)),this._callRemote("createAnswer",`onSuccess, onFailure, ${JSON.stringify(y)}`,w=>{this._answer=w,l&&l(w)},g)}setLocalDescription(e,i,o){return this.localDescription=e,this._callRemote("setLocalDescription",`new RTCSessionDescription(${JSON.stringify(e)}), onSuccess, onFailure`,i,o)}setRemoteDescription(e,i,o){return this.remoteDescription=e,this._callRemote("setRemoteDescription",`new RTCSessionDescription(${JSON.stringify(e)}), onSuccess, onFailure`,i,o)}addIceCandidate(e,i,o){return this._callRemote("addIceCandidate",`new RTCIceCandidate(${JSON.stringify(e)}), onSuccess, onFailure`,i,o)}close(){this._eval(`
      ...
      `,i=>{for(let o of i){let l=o.stats;delete o.stats,o.names=()=>Object.keys(l),o.stat=g=>l[g]}e({result:()=>i})})}_eval(e,i,o){let l,g;const y=new Promise((p,q)=>{l=p,g=q}),w=r.default.randomBytes(16).toString("hex");return c.once(w,p=>{p.err?(o&&o(p.err),g(p.err)):(i&&i(p.res),l(p.res))}),c.eval(JSON.stringify(this._id),`
        (function () {
      ...
      `,p=>{p&&h.emit("error",p,this)}),y}_callRemote(e,i,o,l){return this._eval(`pc.${e}(${i||""})`,o,l)}}},v.exports}var D,L;function de(){return L||(L=1,D=class{constructor(n){this.type=n.type,this.sdp=n.sdp}toJSON(){return this}}),D}var O,E;function ce(){return E||(E=1,O=class{constructor(n){this.candidate=n.candidate,this.sdpMid=n.sdpMid,this.sdpMLineIndex=n.sdpMLineIndex}}),O}var le=$.exports;Object.defineProperty(le,"__esModule",{value:!0});const ue=S,he=re;$.exports=function(u){const n=new he(u),r=new ue.EventEmitter;return Object.assign(r,{close:n.close.bind(n),electronDaemon:n,init:n.init.bind(n),RTCPeerConnection:ae()(n,r),RTCSessionDescription:de(),RTCIceCandidate:ce(),RTCDataChannel:B()(n,r)})};var fe=$.exports;const pe=Q(fe),N=pe();N.init();const A=F({wrtc:N}),Te={libp2p:{transports:[z(),j(),A.transport,G()],peerDiscovery:[A.discovery],addresses:{listen:U}}};export{Te as default};
//# sourceMappingURL=configÉlectronPrincipal-549f2452.js.map
