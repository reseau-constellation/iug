import{w as F}from"./index-AkxszOJV.js";import{w as H,A as z}from"./const-vrkB09v2.js";import{w as V}from"./index-AK194axe.js";import{w as X}from"./index-bpu19AFc.js";import{a as Y,e as C,Q as _,a2 as T,r as K,g as Z}from"./index-D_G_dZW9.js";import{r as ee}from"./path-cJhs4rAV.js";import{b as S}from"./browser-83Pb6Pr1.js";var I={exports:{}},W={exports:{}},x={};const J="/home/runner/work/iug/iug/node_modules/electron";var E={};const k=Y,$=ee,L=$.join(J,"path.txt");function te(){let l;if(k.existsSync(L)&&(l=k.readFileSync(L,"utf-8")),E.ELECTRON_OVERRIDE_DIST_PATH)return $.join(E.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(J,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var j=te(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ne=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
...
//# sourceMappingURL=configÉlectronPrincipal-UirkFdR6.js.map
