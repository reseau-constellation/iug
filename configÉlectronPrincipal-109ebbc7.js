import{w as U}from"./index-f8f22782.js";import{w as F,A as z}from"./const-62df1d20.js";import{w as H}from"./index-0ec9d03a.js";import{w as V}from"./index-b83205e7.js";import{z as X,aq as Y,g as K,ar as _,m as C,a6 as S,as as T,r as Z,k as ee}from"./index-cdb53a54.js";var I={exports:{}},W={exports:{}},x={};const B="/home/runner/work/iug/iug/node_modules/electron",te=X(Y),E=K,$=te,k=$.join(B,"path.txt");function ne(){let l;if(E.existsSync(k)&&(l=E.readFileSync(k,"utf-8")),{}.ELECTRON_OVERRIDE_DIST_PATH)return $.join({}.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(B,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var J=ne(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ie=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
...
//# sourceMappingURL=configÉlectronPrincipal-109ebbc7.js.map
