import{w as F}from"./index-8z3DI95X.js";import{w as H,A as V}from"./const-q-voByQB.js";import{w as z}from"./index-nlWfRaCr.js";import{w as X}from"./index-Y-Z3jIPP.js";import{a as Y,i as C,V as _,a6 as T,r as K,g as Z}from"./index-KwedNMoD.js";import{r as ee}from"./path-SSgeoN6e.js";import{b as S}from"./browser-KiF4y8UL.js";var I={exports:{}},W={exports:{}},x={};const J="/home/runner/work/iug/iug/node_modules/electron";var E={};const k=Y,$=ee,L=$.join(J,"path.txt");function te(){let l;if(k.existsSync(L)&&(l=k.readFileSync(L,"utf-8")),E.ELECTRON_OVERRIDE_DIST_PATH)return $.join(E.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(J,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var j=te(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ne=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
  ...
  `;R.getRelayWindow=ne;Object.defineProperty(x,"__esModule",{value:!0});const M=j,ie=R,re=S,f=re("electron-webrtc-relay:ResourceManager");class se{constructor(n,r){this.maxWindows=1,this.windowIDtoStatsMap=new Map,this.referenceToWindowMap=new Map,this.rollingCounter={i:0,length:0},this.internalWindowCounter=0,this.internalWindowQueueBuffer=0,this.opts=n,typeof this.opts.maxWindows>"u"&&(this.opts.maxWindows=1),this.maxWindows=this.opts.maxWindows,this.opts.debug&&(f.enabled=!0),this.registerListener(),this.openWindow(r)}openWindow(n){if(f("trying to create window"),this.internalWindowQueueBuffer+=15,this.internalWindowCounter>=this.maxWindows)return!1;const r=this.internalWindowCounter.toString();this.internalWindowCounter++,f(`creating window: ${r}`);const a=new M.BrowserWindow({title:"WRTC Relay",width:this.opts.debug?900:0,height:this.opts.debug?750:0,transparent:!this.opts.debug,frame:this.opts.debug,alwaysOnTop:!1,skipTaskbar:!0,center:!0,show:!0,webPreferences:{nodeIntegration:typeof this.opts.preload!="string",contextIsolation:typeof this.opts.preload=="string",webSecurity:!0,preload:typeof this.opts.preload=="string"?this.opts.preload:"",devTools:!!this.opts.debug}});this.opts.debug&&a.webContents.openDevTools(),a.webContents.setWebRTCIPHandlingPolicy(typeof this.opts.webrtcPolicy=="string"?this.opts.webrtcPolicy:"default");const c="data:text/html;charset=UTF-8,"+encodeURIComponent((0,ie.getRelayWindow)(typeof this.opts.preload=="string",typeof this.opts.debug<"u"&&this.opts.debug));return a.loadURL(c),a.on("ready-to-show",()=>{a.webContents.send("WRTCRelayData",{id:"relayInit",code:`window.windowID = ${r}
      ...
      `,p=>{p&&h.emit("error",p,this)}),y}_callRemote(e,i,o,u){return this._eval(`pc.${e}(${i||""})`,o,u)}}},v.exports}var D,N;function we(){return N||(N=1,D=class{constructor(n){this.type=n.type,this.sdp=n.sdp}toJSON(){return this}}),D}var O,q;function ye(){return q||(q=1,O=class{constructor(n){this.candidate=n.candidate,this.sdpMid=n.sdpMid,this.sdpMLineIndex=n.sdpMLineIndex}}),O}var be=I.exports;Object.defineProperty(be,"__esModule",{value:!0});const ve=_,me=he;I.exports=function(l){const n=new me(l),r=new ve.EventEmitter;return Object.assign(r,{close:n.close.bind(n),electronDaemon:n,init:n.init.bind(n),RTCPeerConnection:ge()(n,r),RTCSessionDescription:we(),RTCIceCandidate:ye(),RTCDataChannel:Q()(n,r)})};var Ce=I.exports;const _e=Z(Ce),G=_e();G.init();const B=z({wrtc:G}),Le={libp2p:{transports:[X(),F(),B.transport,H()],peerDiscovery:[B.discovery],addresses:{listen:V}}};export{Le as default};
//# sourceMappingURL=configÉlectronPrincipal-LGxwMOIk.js.map
