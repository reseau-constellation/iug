import{w as F}from"./index-YrmdyYoo.js";import{w as H,A as V}from"./const-HkA9brJg.js";import{w as z}from"./index-K-bvuG_3.js";import{w as X}from"./index-_gMXP7o6.js";import{a as Y,i as C,V as _,a6 as T,r as K,g as Z}from"./index-n7sWkDCA.js";import{r as ee}from"./path-aRghR34O.js";import{b as S}from"./browser-1ty_oOoV.js";var I={exports:{}},W={exports:{}},x={};const J="/home/runner/work/iug/iug/node_modules/electron";var E={};const k=Y,$=ee,L=$.join(J,"path.txt");function te(){let l;if(k.existsSync(L)&&(l=k.readFileSync(L,"utf-8")),E.ELECTRON_OVERRIDE_DIST_PATH)return $.join(E.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(J,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var j=te(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ne=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
...
//# sourceMappingURL=configÉlectronPrincipal-WI_00rlg.js.map
