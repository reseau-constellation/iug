import{w as F}from"./index-JCO0B5Lw.js";import{w as H,A as V}from"./const-Y_BmnXN-.js";import{w as z}from"./index-BZ5v-BRj.js";import{w as X}from"./index-Kt9BNWw_.js";import{a as Y,i as C,V as _,a6 as T,r as K,g as Z}from"./index-iKJF7gGf.js";import{r as ee}from"./path-btx2jnyq.js";import{b as S}from"./browser-2doMszcU.js";var I={exports:{}},W={exports:{}},x={};const J="/home/runner/work/iug/iug/node_modules/electron";var E={};const k=Y,$=ee,L=$.join(J,"path.txt");function te(){let l;if(k.existsSync(L)&&(l=k.readFileSync(L,"utf-8")),E.ELECTRON_OVERRIDE_DIST_PATH)return $.join(E.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(J,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var j=te(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ne=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
...
//# sourceMappingURL=configÉlectronPrincipal-awvqEK4O.js.map
